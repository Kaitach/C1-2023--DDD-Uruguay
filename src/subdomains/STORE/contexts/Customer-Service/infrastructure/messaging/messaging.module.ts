...
import {
  IPrinceModifiedEventPublisher,
  IStateModifiedEventPublisher,
} from './publisher/order/manga';
import {
  ISalesObtainedEventPublisher,
  ISellerModifiedEventPublisher,
  IAddedSellerEventPublisher,
  IBillModifiedEventPublisher,
  IPaymentMethodEventPublisher,
...
import { subscriberGeneric } from './subscriber/subscriber-generic';
...
@Module({
  ...
  providers: [
    IOrderAddEventPublisher,
    IClientAddEventPublisher,
    IBillObtainedEventPublisher,
    IAddedSaleEventPublisher,
    INameMangaModifiedEventPublisher,
    IClientObtainedEventPublisher,
    IClientOrderObtainedEventPublisher,
    ISellerNameModifiedEventPublisher,
    INameModifiedEventPublisher,
    IOrderAddEventPublisher,
    IUpdateNameSellerName,
    ISalesObtainedEventPublisher,
    ISellerModifiedEventPublisher,
    IAddedSellerEventPublisher,
    IBillModifiedEventPublisher,
    ...
    IAddedSaleEventPublisher,
    ISellerNameModifiedEventPublisher,
    ISellerObtainedEventPublisher,
    ITotalModifiedEventPublisher,
    IPaymentMethodEventPublisher,
    IOrderModifiedEventPublisher,
    IMangaModifiedEventPublisher,
    IMangaObtainedEventPublisher,
